...
import comm.example.rane22sau.integrated_level_1.global_variables;
...
public class Move_dist extends MainActivity implements CameraBridgeViewBase.CvCameraViewListener2{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        s_min.setProgress(gv.getC());
        s_max.setProgress(gv.getE());
        v_min.setProgress(gv.getB());
    ...
    public Mat onCameraFrame(CameraBridgeViewBase.CvCameraViewFrame inputFrame) {
        ...
        Log.d("TAG",""+gv.a+" "+gv.b+" "+gv.c+" "+gv.d+" "+gv.e+" "+gv.f);
        F=inputFrame.rgba();
        ...
        Core.inRange(B,new Scalar(gv.a,gv.b,gv.c), new Scalar(gv.d,gv.e,gv.f),B);
